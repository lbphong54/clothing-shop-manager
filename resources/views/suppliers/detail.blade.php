              ...
              <!-- Card infor -->
                <div class="p-3 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div class="flex items-center mb-2">
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ $nhaCungCap->ten }}</p>
                    </div>
                </div>  
              
            </div>
            <div class="update-product">
              <button class="update-button" > <a href="{{ route('suppliers.update',['id'=>$nhaCungCap->id]) }}"> Cập nhật thông tin </a> </button>||
              <button class="delete-button" > <a href="{{ route('suppliers.delete',['id'=>$nhaCungCap->id]) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"> Xóa </a> </button>
            </div>
            <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
