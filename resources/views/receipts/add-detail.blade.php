...
<form action="{{ route('receipts.start-add-detail',['id'=>$phieuNhap->id]) }}" method="POST" style="margin-left: -100;" id="myForm">
    @csrf
    <div class="col-12">     
        <div class="row">
            <div class="col-4">
                <div class="row">
                    <div class="col-md-12">
                        <input type="text" name="phieuNhapID" class="form-control" id="phieuNhapID" value="{{$phieuNhap->id}}" hidden>
                        <label for="nha_cung_cap" class="form-label">Nhà cung cấp</label>
                        <input type="text" name="nhaCungCapSelect" class="form-control" id="nhaCungCapSelect" value="{{$phieuNhap->nha_cung_cap->ten}}" readonly>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input type="date" name="ngay_nhap" class="form-control" id="ngay-nhap" value="{{$phieuNhap->ngay_nhap}}" readonly>
                    </div>
                </div>
            </div>
            <div class="col-8">
                ...
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <input type="khuyen_mai" name="khuyen_mai" class="form-control" id="khuyen_mai" readonly>
...
<script src="{{ asset('js/themNhapHang.js') }}"></script>
