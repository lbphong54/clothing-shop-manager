...
<main class="h-full overflow-y-auto">
          <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
              <!-- Card -->
              <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800" onclick="window.location.href = '{{ route('admin.add') }}';">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400" >
                      ...
                      <td class="px-4 py-3">                      
                          <div class="flex items-center text-sm">
                            <div>
                              <p class="font-semibold">{{$admin->ten_dang_nhap}}</p>                              
                            </div>
                          </div>
                      </td>
                      ...
                      <td class="px-4 py-3 text-sm"> 
                        <button type="button" class="delete-button"><a href="{{ route('admin.delete', ['id' => $admin->id]) }}" class="nav-link active">Xóa</a></button>                                 
                      </td>
